...
export REKOR_HOST=https://rekor-server-rhtap-tas.apps.rosa.snfyt-mcfwg-wr9.l6kv.p3.openshiftapps.com
export IGNORE_REKOR=false
export TUF_MIRROR=https://tuf-rhtap-tas.apps.rosa.snfyt-mcfwg-wr9.l6kv.p3.openshiftapps.com
# Update forced CI test Fri Dec  6 11:31:45 EST 2024
